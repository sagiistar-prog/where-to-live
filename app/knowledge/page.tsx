...
type Hit = { source_id: string; chunk_id?: string; source_title: string; source_url: string; retrieved_at: string; jurisdiction: string; text: string; stale?: boolean };
export default function HousingKnowledge() {
  ...
  return <main className="min-h-screen bg-[#f4f5f8] text-[#222a40]">
    ...
    <div className="mx-auto max-w-4xl px-6 py-12 sm:py-20">
      ...
      <p className="mt-6 max-w-xl leading-7 text-[#525d75]">核对租房合同、押金和办事规则。先选地区，再查与你有关的官方资料。</p>
