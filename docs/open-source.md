...
| [FastEmbed](https://github.com/qdrant/fastembed) | Apache-2.0，ONNX本地CPU推理，明确模型列表 | 住房、CareGuide与EU Law实际使用 |
| [FlagEmbedding](https://github.com/FlagOpen/FlagEmbedding) | BGE模型MIT，区分语言、维数与查询指令 | 住房和CareGuide中文，EU Law英文 |
| [Haystack](https://github.com/deepset-ai/haystack) | Apache-2.0，清洗、检索、融合阶段边界清楚 | 架构参考，未声明整体框架接入 |
| [pgvector](https://github.com/pgvector/pgvector) | PostgreSQL License，复用已有数据库运维能力 | 本地独立实例已实际连接、写入和查询；非线上客户数据库 |
